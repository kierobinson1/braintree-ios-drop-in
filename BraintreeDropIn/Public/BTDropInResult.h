...
/// True if user selected a recent card from the BTPaymentSelectionViewController collectionView.
@property (nonatomic, assign, getter=isRecentCard) BOOL recentCard;
